use crate::game::{actions, combat, interactions, legacy, screens};
...
pub(crate) fn dispatch(
    ...
    match action {
        ...
        actions::GameAction::SearchRemains => legacy::search_remains(state)?,
        ...
        actions::GameAction::TestDeath => legacy::force_death(state),
